    ...
    <TableRow>
      ...
      <TableCell className="text-right">
        <Button 
          variant="outline" 
          size="sm"
          onClick={() => router.push(`/dashboard/admin/grading/${submission.id}`)}
        >
  ...
  return (
    <main className="p-4 md:p-6 lg:p-8">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold">Grading Overview</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A list of all recent assignment submissions across the platform.
          </CardDescription>
        </CardHeader>
        <CardContent>
